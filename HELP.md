...
* The original package name 'com.hanaloop.tool..hanaeco-integration-test-tool' is invalid and this project uses 'com.hanaloop.tool.hanaeco_integration_test_tool' instead.
...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/3.5.9-SNAPSHOT/specification/configuration-metadata/annotation-processor.html)
